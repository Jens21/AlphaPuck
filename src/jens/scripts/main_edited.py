...
# from agents.efficientzero_jens import EfficientZero_Jens
# from agents.efficientzero_jens_final_single_proc import EfficientZero_Jens_Final_Single_Proc
# from agents.efficientzero_jens_final_single_proc_2 import EfficientZero_Jens_Final_Single_Proc_2
# from agents.efficientzero_jens_final_multi_proc_test import EfficientZero_Jens_Final_Multi_Proc_Test
# from agents.efficientzero_jens_final_multi_proc import EfficientZero_Jens_Final_Multi_Proc
# from agents.efficientzero_jens_final_multi_proc_gpu import EfficientZero_Jens_Final_Multi_Proc_GPU
# from agents.efficientzero_jens_final_multi_proc_gpu_frameskip import EfficientZero_Jens_Final_Multi_Proc_GPU_Frameskip
from agents.muzero_jens import MuZero_Jens
# from agents.efficientzero_jens_final_fix_multi_proc_22 import EfficientZero_Jens_Final_Fix_Multi_Proc_22
# from agents.efficientzero_jens_final_fix_multi_proc_3 import EfficientZero_Jens_Final_Fix_Multi_Proc_3
...
def get_agent_from_player(player: str) -> Agent | h_env.BasicOpponent:
    ...
    if player == "Jens":
        return MuZero_Jens('agents/checkpoints/agent_35000.pth') # agent_1025000
    elif player == "Fabrice":
